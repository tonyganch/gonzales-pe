module.exports = function(css) {
    ...
    function parseEquality(css) {
        ...
        if (css.charAt(pos) === '=' && css.charAt(pos+1) == '=') {
            ...
            var equality = css.substring(start, start + 2);
            pushToken(TokenType.EqualitySign, equality, startCol);
        }
    }
    ...
    function parseInequality(css) {
        ...
        if (css.charAt(pos) === '!' && css.charAt(pos+1) == '=') {
            ...
            var inequality = css.substring(start, start + 2);
            pushToken(TokenType.InequalitySign, inequality, startCol);
        }
    }
