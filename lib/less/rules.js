    ...
    */
    ...
    function getAtrulers() {
        ...
        while (!tokens[pos].atrulers_end) {
            ...
            else if (childType === 2) x.push(getAtrule());
            else if (childType === 3) x.push(getRuleset());
        }
    ...
    function getClass() {
        ...
        if (childType === 1) x.push(getInterpolatedVariable());
    ...
    function getEscapedString() {
        ...
        return getNode(startPos, NodeType.EscapedStringType, x);
    }
    ...
    function getInterpolatedVariable() {
        ...
        return getNode(startPos, NodeType.InterpolatedVariableType, x);
    }
