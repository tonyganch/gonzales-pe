...
function checkAny(i) {
    ...
    else if (l = checkFunctionExpression(i)) tokens[i].any_child = 8;
...
function getAny() {
    ...
    else if (childType === 8) return getFunctionExpression();
...
function getFilterp() {
    ...
    token = tokens[pos];
    var ident = newNode(NodeType.IdentType, joinValues2(pos, token.filterp_l), token.ln, token.col);
...
function getImportant() {
    ...
    var offset = content ? 9 : 10;
    var end = getLastPosition(content, line, column, offset);
    pos++;
