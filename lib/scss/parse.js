...
/////////////////////////////////////
    ...
    */
    ...
    function getDeclDelim() {
        ...
        var token = tokens[startPos];
        return new Node(NodeType.DeclDelimType, null, token.ln, token.col);
    }
    ...
    function getDelim() {
        ...
        var token = tokens[startPos];
        return new Node(NodeType.DelimType, null, token.ln, token.col);
    }
    ...
    function getNamespace() {
        ...
        var token = tokens[startPos];
        return new Node(NodeType.NamespaceType, null, token.ln, token.col);
    }
    ...
    function getPropertyDelim() {
        ...
        var token = tokens[startPos];
        return new Node(NodeType.PropertyDelimType, null, token.ln, token.col);
    }
